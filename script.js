...
function reveseIsComplete() {
    if (isComplete.checked == true) {
        bookSubmit.querySelector('span').textContent = 'Selesai dikerjakan'
    } else {
        bookSubmit.querySelector('span').textContent = 'Belum selesai dikerjakan'
    }
}
